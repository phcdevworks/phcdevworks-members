...
module PhcdevworksMembers
  class Member::ListingsController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @member_listing.save
          format.html { redirect_to @member_listing, notice: 'Listing was successfully created.' }
    ...
    def update
      ...
      respond_to do |format|
        if @member_listing.update(member_listing_params)
          format.html { redirect_to @member_listing, notice: 'Listing was successfully updated.' }
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to member_listings_url, notice: 'Listing was successfully destroyed.' }
